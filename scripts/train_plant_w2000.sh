#!/bin/bash
#SBATCH --job-name=helion-plant-w2000
...
#SBATCH --output=/storage3/fs1/shandley/Active/helion/logs/%j_train_plant_w2000.out
#SBATCH --error=/storage3/fs1/shandley/Active/helion/logs/%j_train_plant_w2000.err

set -euo pipefail

HELION_ROOT="/storage3/fs1/shandley/Active/helion"
DATA_DIR="${HELION_ROOT}/data/plant"
MODEL_OUT="${HELION_ROOT}/models/plant_w2000"
