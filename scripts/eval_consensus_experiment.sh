...
LP_TAG=""
[ "${LENGTH_PENALTY}" != "0.0" ] && LP_TAG="_lp${LENGTH_PENALTY}"
PRED="${H}/results/pred_${MODEL}_on_${DATA}_chr${CHROM}_t${THRESHOLD}_consensus${BC_TAG}${SW_TAG}${LP_TAG}.gff3"
...
helion predict \
    ...
    --length-penalty    "${LENGTH_PENALTY:-0.0}" \
    --device            "${DEVICE}"
