#!/bin/bash
#SBATCH --job-name=helion-train-plant-v2
...
#SBATCH --output=/storage3/fs1/shandley/Active/helion/logs/%j_train_plant_v2.out
#SBATCH --error=/storage3/fs1/shandley/Active/helion/logs/%j_train_plant_v2.err

set -euo pipefail

HELION_ROOT="/storage3/fs1/shandley/Active/helion"
DATA_DIR="${HELION_ROOT}/data/plant"
MODEL_OUT="${HELION_ROOT}/models/plant_v2"
